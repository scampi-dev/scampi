...
func Test_CheckPlan_EmitsDriftDetail(t *testing.T) {
...
func Test_CheckPlan_EmitsNoDriftWhenSatisfied(t *testing.T) {
	opA := &harness.FakeOp{
		Name:    "A",
...
func Test_ExecutePlan_EmitsNoDrift(t *testing.T) {
	opA := &harness.FakeOp{
		Name:    "A",
