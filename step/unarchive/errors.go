...
func (e UnsupportedArchiveError) Diagnostic() event.Event {
	return event.Error{
...
func (e ArchiveNotFoundError) Diagnostic() event.Event {
	return event.Error{
		Impact: event.ImpactAbort,
		Template: event.Template{
...
func (e ExtractionError) Diagnostic() event.Event {
	return event.Error{
		Impact: event.ImpactAbort,
		Template: event.Template{
...
func (e ArchiveReadError) Diagnostic() event.Event {
	if e.Entry != "" {
		return event.Error{
			Impact: event.ImpactAbort,
			Template: event.Template{
