...
# normalize sibling refs, dedup-check, and verify cited locations. On
# pass, claude moves the draft to .issues/pusher-inbox/ (the push-loop's
# queue). On fail, claude writes a .failed.txt sidecar.
#
