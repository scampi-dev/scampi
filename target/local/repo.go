...
func (t POSIXTarget) VersionCodename() string {
	return t.osInfo.VersionCodename
}

// RepoManager — apt/dnf backend
// -----------------------------------------------------------------------------
...
func (t POSIXTarget) RepoKeyPath(name string) string {
	switch t.pkgBackend.Kind {
	case pkgmgr.Apt:
...
func (t POSIXTarget) RepoConfigPath(name string) string {
	switch t.pkgBackend.Kind {
	case pkgmgr.Apt:
