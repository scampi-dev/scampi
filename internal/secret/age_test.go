...
func Test_Age_RoundTripsPlaintext(t *testing.T) {
...
func Test_IsAgeEncrypted_DetectsWrapper(t *testing.T) {
	tests := []struct {
		input string
		want  bool
	}{
...
func Test_AgeBackend_DecryptsStoredValues(t *testing.T) {
	id := generateTestKeypair(t)
...
func Test_AgeBackend_RejectsInvalidBase64(t *testing.T) {
	data, _ := json.Marshal(map[string]string{
...
func Test_AgeBackend_RejectsWrongIdentity(t *testing.T) {
...
func Test_AgeBackend_RejectsInvalidJSON(t *testing.T) {
	id := generateTestKeypair(t)
...
func Test_ResolveIdentities_HonorsEnvKey(t *testing.T) {
	id := generateTestKeypair(t)
...
func Test_ResolveIdentities_HonorsEnvKeyFile(t *testing.T) {
	id := generateTestKeypair(t)
...
func Test_ResolveIdentities_FallsBackToDefaultFile(t *testing.T) {
	id := generateTestKeypair(t)
...
func Test_ResolveIdentities_ErrorsWhenNothingAvailable(t *testing.T) {
