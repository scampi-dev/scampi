...
func Test_Resolve_MapsOffsetToLineCol(t *testing.T) {
	src := []byte("hello\nworld\n  foo\n")
	//             ^0    ^6   ^12   ^18 (length)
	//             h=0   w=6   f=14
	//             e=1   o=7
...
func Test_Resolve_CountsMultiByteRuneAsOneCol(t *testing.T) {
...
func Test_ResolveSpan_ResolvesBothEndpoints(t *testing.T) {
	src := []byte("foo\nbar baz\n")
	//             0123 456789...
...
func Test_Lookup_MapsKeywordsToKinds(t *testing.T) {
	cases := []struct {
		in   string
		want Kind
	}{
...
func Test_EndsStatement_ClassifiesTerminalKinds(t *testing.T) {
	cases := []struct {
		k    Kind
		want bool
	}{
