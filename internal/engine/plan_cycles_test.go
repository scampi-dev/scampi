...
func Test_DetectPlanCycles_AcceptsAcyclicOps(t *testing.T) {
...
func Test_DetectPlanCycles_RejectsOpCycle(t *testing.T) {
	act := &mockStep{desc: "test", kind: "test"}
	opA := &mockOp{step: act}
	opB := &mockOp{step: act}
...
func Test_DetectPlanCycles_AcceptsEmptyPlan(t *testing.T) {
	plan := spec.Plan{}
	err := DetectPlanCycles(discardCtx(t), plan)
	if err != nil {
...
func Test_DetectHookCycles_AcceptsAcyclicHooks(t *testing.T) {
...
func Test_DetectHookCycles_RejectsSimpleCycle(t *testing.T) {
	hooks := map[string][]spec.DeclaredStep{
...
func Test_DetectHookCycles_RejectsSelfCycle(t *testing.T) {
	hooks := map[string][]spec.DeclaredStep{
...
func Test_DetectHookCycles_AcceptsEmptyHooks(t *testing.T) {
...
func Test_DetectHookCycles_RejectsThreeNodeCycle(t *testing.T) {
	hooks := map[string][]spec.DeclaredStep{
		"a": {{OnChange: []string{"b"}, Fields: map[string]spec.FieldSpan{}}},
...
func Test_DetectStepCycles_FindsSimpleCycle(t *testing.T) {
	// A writes /a, reads /b
	// B writes /b, reads /a
	// -> cycle: A -> B -> A
	steps := []spec.Step{
